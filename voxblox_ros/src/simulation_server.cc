...
SimulationServer::SimulationServer(
  ...
  raw_height_test_.reset(new Layer<HeightVoxel>(voxel_size_, voxels_per_side_));

  tsdf_integrator_.reset(
      new MergedTsdfIntegrator(tsdf_integrator_config, tsdf_test_.get(), raw_height_test_.get()));
